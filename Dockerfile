...
CMD ["sh", "-c", "python manage.py migrate --noinput && python scripts/update_user_credentials.py && python manage.py collectstatic --noinput && gunicorn erp_system.wsgi:application --bind 0.0.0.0:${PORT:-8000}"]
