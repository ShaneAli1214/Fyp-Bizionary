                    ...
                    <div className="p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                ...
                                className="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-full shadow-md text-sm font-bold text-card bg-[#2B2620] hover:bg-[#2B2620] active:bg-[#152e4a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2B2620] transition-colors disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wider"
                            >
                                {isLoading ? (
