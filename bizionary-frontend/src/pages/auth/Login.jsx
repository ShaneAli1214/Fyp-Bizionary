...
const Login = () => {
    ...
    return (
        <div className="min-h-screen w-full flex bg-white font-sans">
            ...
            <div className="hidden lg:flex lg:w-[45%] bg-[#111111] relative text-white flex-col justify-between p-12 overflow-hidden select-none">
                {/* Subtle dot grid */}
                ...
                <div className="flex items-center gap-3 relative z-10">
                    ...
                    <span className="text-base font-black tracking-widest uppercase text-white">Bizionary</span>
                </div>
                ...
                <div className="space-y-6 relative z-10">
                    {[
                        ...
                        <div key={title} className="flex items-start gap-4">
                            <div className="bg-white/10 p-2.5 rounded-xl border border-white/8 flex items-center justify-center shrink-0">
                                <Icon className="w-5 h-5 text-white" />
                            </div>
                            <div>
                                <h3 className="text-sm font-bold text-white">{title}</h3>
                                <p className="text-xs text-white/50 mt-0.5 font-medium">{desc}</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 md:px-12 lg:px-16 bg-white relative">
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-2xl font-black text-gray-900 tracking-widest uppercase">Bizionary</span>
                        </div>
                        <h2 className="text-xl font-bold text-gray-900 mt-6 tracking-tight">
                            Sign in to your account
                        </h2>
                        <p className="text-gray-400 mt-2 text-xs font-semibold">
                            {twoFactorRequired
                    ...
                    {/* Error banner */}
                    {error && (
                        <div className="p-4 rounded-xl bg-rose-50 text-rose-600 border border-rose-100 text-xs font-semibold">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        {twoFactorRequired ? (
                            <div>
                                <label className="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2 pl-0.5">
                                    Authenticator Code
                                </label>
                                <div className="relative">
                                    <input
                                        ...
                                        className="block w-full px-4 py-3.5 border border-gray-200 rounded-xl outline-none transition-all placeholder-gray-300 bg-gray-50 focus:bg-white text-center font-mono font-bold tracking-widest text-lg text-gray-900 shadow-sm"
                                        placeholder="000000"
                                        required
                                    />
                            ...
                            <>
                                ...
                                <div className="space-y-2">
                                    <label className="block text-xs font-bold text-gray-700 uppercase tracking-wider pl-0.5">
                                        Email Address
                                    </label>
                                    <div className="relative">
                                        <input
                                            ...
                                            className="block w-full pl-4 pr-12 py-3.5 border border-gray-200 rounded-xl outline-none transition-all placeholder-gray-300 bg-gray-50 focus:bg-white text-gray-900 shadow-sm text-sm"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="block w-full pl-4 pr-20 py-3.5 border border-gray-200 rounded-xl outline-none transition-all placeholder-gray-300 bg-gray-50 focus:bg-white text-gray-900 shadow-sm text-sm"
                                        ...
                                        <button
                                            ...
                                            className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-300 hover:text-gray-600 p-1 focus:outline-none transition-colors"
                                    ...
                                    <div className="flex justify-end pt-1">
                                        <a
                                            href="#"
                                            className="text-xs font-bold text-gray-400 hover:text-gray-900 hover:underline transition-colors"
                                        >
                                            Forgot password?
                                        </a>
                                    </div>
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full flex justify-center py-3.5 px-4 rounded-xl text-sm font-bold text-white bg-[#111111] hover:bg-gray-800 active:scale-[0.985] transition-all duration-200 shadow-sm focus:outline-none cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {isLoading ? (
                    ...
                    {!twoFactorRequired && (
                        <>
                            ...
                            <button
                                ...
                                className="w-full py-3 px-4 border border-gray-200 rounded-xl text-sm font-bold text-gray-700 bg-white hover:bg-gray-50 active:scale-[0.985] transition-all duration-200 flex items-center justify-center gap-2.5 shadow-sm"
                            >
                    ...
                    {/* Footer */}
                    <div className="pt-2 text-center text-xs font-semibold text-gray-400">
                        Don't have an account?{' '}
                        <span
                            onClick={() => alert('Please contact your IT department or local system administrator to provision new employee access.')}
                            className="text-gray-900 hover:underline font-bold cursor-pointer transition-colors"
                        >
