            ...
            <div className="bg-card rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200 border border-card">
                ...
                <div className="px-6 py-4 border-t border-card flex justify-end gap-3 bg-card">
                    <button 
                        type="button"
                        onClick={onClose}
                        className="px-5 py-2.5 text-xs font-bold text-secondary hover:text-primary bg-card border border-card hover:bg-page rounded-xl transition-all"
                    >
                        Cancel
                    </button>
                    <button 
                        type="submit"
                        form="user-form"
                        className="px-5 py-2.5 text-xs font-bold text-card bg-[#2B2620] hover:bg-[#2B2620] active:bg-[#152e4a] rounded-xl shadow-md transition-all transform hover:-translate-y-0.5"
                    >
